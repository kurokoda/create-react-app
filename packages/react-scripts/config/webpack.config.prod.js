...
const sanitizedBuildNumber = (buildNumber && buildNumber.replace(/[^.a-zA-z0-9]/g, "")) || "999.999.999";
...
const cssFilename = `static/css/[name].${sanitizedBuildNumber}.css`;
      ...
      },
      {
        ...
        oneOf: [
          ...
          // assets smaller than specified size as data URLs to avoid requests.
          {
            ...
            options: {
              limit: 10000,
              name: `static/media/[name].${sanitizedBuildNumber}.[ext]`,
            },
          },
